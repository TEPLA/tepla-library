...
{
	if( strcmp(param, "bn254_fp") == 0 )
	{
		f->field_init  = ec_bn254_fp_new;
		f->field_clear = ec_bn254_field_clear;
	}
	else if( strcmp(param, "bn254_fp2") == 0 )
	{
		f->field_init  = ec_bn254_fp2_new;
		f->field_clear = ec_bn254_field_clear;
	}
	else if( strcmp(param, "bn254_fp6") == 0 )
	{
		f->field_init  = ec_bn254_fp6_new;
		f->field_clear = ec_bn254_field_clear;
	}
	else if( strcmp(param, "bn254_fp12") == 0 )
	{
		f->field_init  = ec_bn254_fp12_new;
		f->field_clear = ec_bn254_field_clear;
	}
	else
	{
...
{
	if( strcmp(param, "ec_bn254_fp") == 0 )
	{
		ec->curve_init = ec_bn254_fp_group_new;
		ec->curve_clear = ec_bn254_group_clear;
	}
	else if( strcmp(param, "ec_bn254_tw") == 0 )
	{
		ec->curve_init = ec_bn254_tw_group_new;
		ec->curve_clear = ec_bn254_group_clear;
	}
	else
	{
...
{
	if ( strcmp(param, "ECBN254") == 0 )
	{
		ec_bn254_pairing_new(p);
	}
	else
	{
